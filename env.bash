...
export VINS_TOPICS="/ov_msckf/trackhist/compressed /ov_msckf/loop_depth_colored/compressed /ov_msckf/pathimu /ov_msckf/pathgt /ov_msckf/points_msckf /ov_msckf/points_slam /ov_msckf/loop_feats /ov_msckf/points_sim"
...
# export VINS_CONFIG=bee_heavy1
# export VINS_CONFIG=bee_heavy4
# export VINS_CONFIG=bee_heavy5
export VINS_CONFIG=firefly3
